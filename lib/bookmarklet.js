...
export function buildBookmarkletSource(wsURL, clientScript) {
  ...
  function updateClientBars(){
    ...
    Object.keys(clients).forEach(function(id){
      ...
      Object.assign(thumb.style,{position:'absolute',left:'0',width:'100%',height:thumbPct+'%',top:thumbTopPct+'%',background:color,opacity:'0.85'});
