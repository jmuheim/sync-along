...
import { buildBookmarklet, buildBookmarkletCode, buildStubBookmarklet } from './bookmarklet.js';
...
<body>
  ...
  <div class="card">
    ...
    <div class="bookmarklet-wrap">
      <textarea id="bm-text" readonly>${escapeHTML(bookmarklet)}</textarea>
...
export function buildDevHTML(ip, port, demoPages) {
  ...
  const rawCode = buildBookmarkletCode(ip, port);
