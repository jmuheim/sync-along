...
- A bookmarklet link to drag to the bookmarks bar
...
1. Save the bookmarklet from the server's index page to your browser's bookmarks bar.
2. Navigate to any song/lyrics page.
...
| File | Role |
|---|---|
| `server.js` | Node.js + WebSocket server; serves `client.html` and relays `page`/`scroll` messages from master to all clients |
